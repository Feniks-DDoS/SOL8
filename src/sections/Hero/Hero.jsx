        ...
        <div className="hero__inner">
            <div className="hero__body container">
                <header className="hero__header"> 
                    ...
                    <p className="hero__subtitle">Discover ultimate relaxation at Serenity Spa - where ancient wellness <br /> meets modern luxury. Book your transformative experience in seconds.</p>
                </header>
